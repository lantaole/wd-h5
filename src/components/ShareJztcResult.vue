    ...
    drawInit(res) {
      ...
      _this.$nextTick(function() {
        ...
        drawImg(
          ...
          recursion(0, _this.listData.length);
        });
      });
      // 循环递归渲染
      function recursion(i, length) {
        setTimeout(function() {
          drawText(
            _this.listData[i].keywordStr,
            true,
            "#333333",
            "12px PingFang-SC-Bold",
            canvas.width / (2 * ratio) - 180,
            i * 31 + 220
          );
          drawText(
            _this.listData[i].allPv,
            true,
            "#333333",
            "12px PingFang-SC-Bold",
          ...
          drawText(
            _this.listData[i].allCtr,
            true,
            "#333333",
            "12px PingFang-SC-Bold",
            canvas.width / (2 * ratio) + 60,
            i * 31 + 220
          );
          drawText(
            _this.listData[i].allCvr,
            true,
            "#333333",
            "12px PingFang-SC-Bold",
            canvas.width / (2 * ratio) + 170,
            i * 31 + 220
          );
          if (++i < length) {
            recursion(i, length);
